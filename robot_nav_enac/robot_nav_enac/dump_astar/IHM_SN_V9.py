...
def foo():
    ...
    trait = Chemin_Astar(Arrive,Depart,liste_obstacle)
...
def Map_init():
    ...
    barre = Rectangle(Points(149.885,1),Points(150.115,30))
    moitie = 1500
    ...
    obstacle_carte.append(r1)
    obstacle_carte.append(r2)
    obstacle_carte.append(r1_bis)
    obstacle_carte.append(r2_bis)
    obstacle_carte.append(barre)

    return obstacle_carte # return liste_obs apres debugage
